...
with ImplicitSender {
  ...
  val display = system.actorOf(Props(new DisplayTest(PlateauConfiguration(5,5))), "Display")
  ...
  private class DisplayTest(definePlateau: PlateauConfiguration) extends Display(definePlateau) {
